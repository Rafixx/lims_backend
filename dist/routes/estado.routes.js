...
router.get('/:entidad(MUESTRA|TECNICA)/inicial', estadoController.getEstadoInicial);
...
router.get('/:entidad(MUESTRA|TECNICA)/finales', estadoController.getEstadosFinales);
